...
def load_api():
    ...
    consumer_key = 'riD6CnHje9aX7w4S4A50oqgeZ'
    consumer_secret = 'l7xZdtroNwZNj8QVTQJUzKLufrMWWGG4WKekZ5OfLvz3ZVQdGl'
    access_token = '1211506885481787392-MK5sbfOTsyxFaFGKpcuAUBc2JxGZji'
    access_secret = 'xMdkq0YZe7mIsySHDLH93SfY6FaczmRPiZRHUQuFvw8oo'
...
def main():
    ...
    #geocode indonesia https://geocode.xyz/-6.17848,106.82685
    geocode_indonesia = '-6.17848,106.82685'                                               # states (and a large portion of Canada)
